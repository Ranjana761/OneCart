  ...
  return (
    ...
    from-[#141414] to-[#0c2025] text-[white] '>
      ...
      justify-start'>
        ...
        mt-[70px] flex flex-col gap-[30px] overflow-x-hidden
        py-[50px] ml-[100px]'>
