...
function Add() {
  ...
  const [bestseller,serBestSeller] = useState(false)
  ...
  return (
    <div className='w-[100vw] min-h-[100vh] bg-gradient-to-bl
      ...
      justify-start overflow-x-hidden absolute right-0 bottom-[5%]'>
        ...
        mt-[70px] flex flex-col gap-[30px] py-[60px] px-[30px]
         ...
         justify-center flex-col gap-[10px]'>
          ...
          bg-slate-600 px-[20px] text-[18px] placeholder:
          text-[#ffffffc2]' onChange={(e)=>setName(e.target.value)}
            value={name} required/>
         </div>
         ...
         justify-center flex-col gap-[10px]'>
          ...
          hover:border-[#46d1f7] border-[2px] cursor-pointer
          bg-slate-600 px-[20px] py-[10px] text-[18px] placeholder:
          text-[#ffffffc2]' onChange={(e)=>setDescription(e.target.value)}
         ...
         flex-wrap '>
          ...
          sm:justify-center flex-col gap-[10px]'>
            ...
            px-[10px] py-[7px] rounded-lg hover:border-[#46d1f7]
            border-[2px]' onChange={(e)=>setCategory(e.target.value)}>
         ...
         justify-center flex-col gap-[10px]'>
          ...
          hover:border-[#46d1f7] border-[2px] cursor-pointer
          bg-slate-600 px-[20px] text-[18px] placeholder:
          text-[#ffffffc2]' onChange={(e)=>setPrice(e.target.value)}
         ...
         md:py-[0px]'>
          ...
          flex-wrap'>
            ...
            "bg-green-400 text-black border-[#46d1f7]":""}`} onClick={()=>setSizes(prev=>
            ...
            "bg-green-400 text-black border-[#46d1f7]":""}`} onClick={()=>setSizes(prev=>
            prev.includes("M") ? prev.filter(item =>item !== "M")
              : [...prev, "M"]
            )}>M</div>
            <div className={`px-[20px] py-[7px] rounded-lg
            bg-slate-600 text-[18px] hover:border-[#46d1f7]
            ...
            "bg-green-400 text-black border-[#46d1f7]":""}`} onClick={()=>setSizes(prev=>
            prev.includes("L") ? prev.filter(item =>item !== "L")
              : [...prev, "L"]
            )}>L</div>
            <div className={`px-[20px] py-[7px] rounded-lg
            bg-slate-600 text-[18px] hover:border-[#46d1f7]
            ...
            "bg-green-400 text-black border-[#46d1f7]":""}`} onClick={()=>setSizes(prev=>
            prev.includes("XL") ? prev.filter(item =>item !== "XL")
              : [...prev, "XL"]
            )}>XL</div>
            <div className={`px-[20px] py-[7px] rounded-lg
            bg-slate-600 text-[18px] hover:border-[#46d1f7]
            border-[2px] cursor-pointer ${sizes.includes("XXL")?
            "bg-green-400 text-black border-[#46d1f7]":""}`} onClick={()=>setSizes(prev=>
            prev.includes("XXL") ? prev.filter(item =>item !== "XXL")
              : [...prev, "XXL"]
            )}>XXL</div>
          </div>
         </div>
         ...
         gap-[10px] mt-[20px]'>
          <input type='checkbox' id='checkbox' className='w-[25px]
          h-[25px] cursor-pointer' onChange={()=>serBestSeller(prev => !prev)}/>
         ...
         bg-[#65d8f7] flec items-center justify-center gap-[10px]
         text-black active:bg-slate-700 active:text-white
         active:border-[2px] border-white'>{loading ? <Loading/>: "Add Product"}</button>
