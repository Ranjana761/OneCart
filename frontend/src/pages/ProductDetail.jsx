...
function ProductDetail() {
  ...
  return productData ? (
    <div>
      <div className='w-full min-h-screen md:h-[100vh] 
        flex  items-center justify-start lg:flex-row flex-col 
        bg-gradient-to-l  from-[#141414] to-[#0c2025] gap-8 px-4 py-10 '>
           ...
           md:gap-[10px] gap-[30px] flex-col-reverse lg:flex-row '>
             ...
             lg:flex-col flex-wrap '>
                ...
                border-[#80808049] rounded-md '>
                    ...
                    h-[100%] cursor-pointer rounded-md ' 
             ...
             <div className='lg:w-[60%] w-[80%] h-[70%]
                lg:h-[78%] border-[1px] border-[#80808049] 
                rounded-md  overflow-hidden'>
                    <img src={image} alt='' className='w-[100%]
                    lg:h-[100%] h-[100%] text-[30px] text-white
           ...
           lg:pl-[0px] lg:px-[0px] lg:py-[0px] gap-[10px] '>
            <h1 className='text-[40px] font-semibold text-[aliceblue]
             ...
             <div className='flex items-center gap-1'>
                ...
                <FaStar className='text-[20px] fill-[#FFD700]'/>
                <FaStar className='text-[20px] fill-[#FFD700]'/>
                <FaRegStarHalfStroke className='text-[20px] 
                fill-[#FFD700]'/>
             ...
             <p className='w-[80%] md:w-[60%] text-[23px]
            text-[white]'>{productData.description} and Stylish,
                ...
                '>
                   ...
                   <div className='flex gap-2'>
                   {
                    productData.sizes.map((item,index)=>(
                        <button key={index} className={`border py-2 
                        px-4 bg-slate-300 rounded-md
                        ${item === size ? 'bg-[black] text-[#2969a1] text-[20px]'
                         :''}`}
        ...
        <div className='w-[100%] min-h-[70vh] flex items-start 
        justify-start  flex-col bg-gradient-to-l  from-[#141414]
         to-[#0c2025] overflow-x-hidden '>
            ...
            md:text-[15px] lg:text-[20px] px-[10px] md:px-[30px]
            lg:ml-[100px] ml-[20px] '>
                <p className='w-[95%] h-[95%] flex items-center
                justify-center '>
                    Upgarade your Wardobe with this stylish slim-fit
                    cotton shirt, available now on OneCart. Crafted 
                    from breathable, high-quality fabric, it offers all-
                    day comfort and effortless style. Easy to maintain 
                    and perfect for any setting, this shirt is must-have 
