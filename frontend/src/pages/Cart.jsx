...
//     },[cartItem])
//   return (
//     <div className='w-[99w] min-h-[100vh] p-[20px]
//     overflow-hidden bg-gradient-to-l from-[#141414]
//     to-[#0c2025]'>
...
//                 return(
//                     <div className='w-[100%] h-[10%] border-t
//                     border-b'>
...
//                           text-[#f3f9fc]'>{productData.name}</p>
//                           <div className='flex items-center gap-[20px]'>
//                           <p className='text-[20px] text-[#aaf4e7]'>
//                           {currency}{productData.price}</p>
//                           <p className='w-[40px] h-[40px] text-[16px]
//                           text-[white] bg-[#518080b4] rounded-md mt-[5px]
...
//                           px-[5px] text-[white] text-[18px] font-semibold
//                            bg-[#518080b4] absolute md:top-[40%] top-[46%]
//                            left-[75%] md:left-[50%] border-[1px] border-[#9ff9f9]
//                            rounded-md ' onChange={(e)=>e.target.value === ' ' ||
//                            e.target.value === '0' ? null : updateQuantity(item._id,
//                            item.size, Number(e.target.value))}/>
//                           <IoTrashBin className='text-[#9ff9f9] w-[25px]
//                           h-[25px] absolute top-[50%] md:top-[40%] md:right-[5%]
//                           right-1' onClick={()=>updateQuantity(item._id,
//                            item.size,0)}/>
//                         </div>
//                     </div>
//             )
