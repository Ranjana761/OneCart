  ...
  return (
    ...
    to-[#0c2025] gap-[50px] pt-[80px]'>
      ...
      flex-col lg:flex-row'>
        ...
        justify-center'>
          <img src={contact} alt='c' className='lg:w-[65%] w-[80%]
        ...
        justify-center gap-[20px] flex-col mt-[20px]
         lg:mt-[0px]'>
          ...
          <p className='lg:w-[80%] w-[100%] text-[white]
           md:text-[16px] text-[13px]'>
            <p>tel: +91-9394673946</p>
            <p>Email: admin@onecart.com</p>
           </p>
           <p className='lg:w-[80%] w-[100%] text-[15px] text-[white]
           lg:text-[18px] mt-[10px] font-bold'>Careers at 
           OneCart</p>
           <p className='lg:w-[80%] w-[100%] text-[white]
           md:text-[16px] text-[13px]'>Learn more about our 
            teams and job openings</p>
            <button className='px-[30px] py-[20px] flex 
            items-center justify-center text-[white] bg-transparent
            border active:bg-slate-600 rounded-md'>Explore
             Jobs</button>
         </div>
      </div>
      <NewLetterBox/>
