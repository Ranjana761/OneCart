...
function NewLetterBox() {
  ...
  return (
    <div className='w-[100%] h-[40vh] bg-gradient-to-l
    ...
    justify-start gap-[10px] flex-col'>
      ...
      text-blue-100 font-semibold px-[20px]'>Subscribe Now and 
        enjoy exclusive savings, special deals, and early access
        to new collections.</p>

      <form action="" onSubmit={handleSubmit} className='w-[100%] h-[30%] md:h-[50%]
      flex items-center justify-center mt-[20px] gap-[20px] 
      px-[20px]'>
